...
RUN apk add --allow-untrusted /packages/bash-4.3.48-r1.apk 
RUN apk add --allow-untrusted /packages/curl-7.55.0-r0.apk 
RUN apk add --allow-untrusted /packages/apache2-2.4.27-r0.apk
